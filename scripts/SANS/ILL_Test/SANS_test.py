...
sensitivity_corrected_ws, sensitivity_ws, sensitivity_message = SANSSensitivityCorrection(InputWorkspace= dark_current_subtracted_ws, Filename=path + "002229.nxs", ReductionProperties="reduction_manager")
