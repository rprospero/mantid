...
*/
class MANTIDUI_WIDGETS_CORE_PUBLIC AbstractAlgorithmInputHistory {
public:
...
class MANTIDUI_WIDGETS_CORE_PUBLIC AlgorithmInputHistoryImpl
...
namespace Mantid {
namespace Kernel {
MANTIDUI_WIDGETS_CORE_EXTERN template class MANTIDUI_WIDGETS_CORE_PUBLIC
