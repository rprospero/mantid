...
#include "MantidUiWidgetsCore/CatalogHelper.h"
#include "MantidUiWidgetsCore/CatalogSelector.h"
#include "MantidUiWidgetsCore/CheckboxHeader.h"
...
class MANTIDUI_WIDGETS_CORE_PUBLIC CatalogSearch : public QWidget {
  Q_OBJECT
