...
#include "MantidUiWidgetsCore/DataProcessorUI/DataProcessorProcessingAlgorithmBase.h"
...
*/
class MANTIDUI_WIDGETS_CORE_PUBLIC DataProcessorPostprocessingAlgorithm
