...
#include "MantidUiWidgetsCore/AlgorithmRunner.h"
#include "MantidUiWidgetsCore/MantidWidget.h"
#include "MantidUiWidgetsCore/InstrumentSelector.h"
...
class MANTIDUI_WIDGETS_CORE_PUBLIC IndirectInstrumentConfig
