...
class MANTIDUI_WIDGETS_CORE_PUBLIC Interval {
public:
...
class MANTIDUI_WIDGETS_CORE_PUBLIC IntervalList {
public:
...
class MANTIDUI_WIDGETS_CORE_PUBLIC IntervalListValidator
    : public QValidator {
  Q_OBJECT
...
class MANTIDUI_WIDGETS_CORE_PUBLIC MantidWSIndexWidget : public QWidget {
  Q_OBJECT
...
class MANTIDUI_WIDGETS_CORE_PUBLIC MantidWSIndexDialog : public QDialog {
  Q_OBJECT
