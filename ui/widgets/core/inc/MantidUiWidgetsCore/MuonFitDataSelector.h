...
#include "MantidUiWidgetsCore/MuonFitPropertyBrowser.h"
#include "MantidUiWidgetsCore/IMuonFitDataSelector.h"
...
*/
class MANTIDUI_WIDGETS_CORE_PUBLIC MuonFitDataSelector
