...
#include "MantidUiWidgetsCore/IMuonFitDataModel.h"
#include "MantidUiWidgetsCore/IMuonFitFunctionModel.h"
...
class MANTIDUI_WIDGETS_CORE_PUBLIC MuonFitPropertyBrowser
