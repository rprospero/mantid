...
#include "MantidUiWidgetsCore/ErrorCurve.h"
#include "MantidUiWidgetsCore/RangeSelector.h"
...
class MANTIDUI_WIDGETS_CORE_PUBLIC PreviewPlot : public API::MantidWidget {
  Q_OBJECT
