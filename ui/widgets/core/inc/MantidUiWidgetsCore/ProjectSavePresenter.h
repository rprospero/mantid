...
#include "MantidUiWidgetsCore/IProjectSerialisable.h"
#include "MantidUiWidgetsCore/IProjectSaveView.h"
#include "MantidUiWidgetsCore/ProjectSaveModel.h"
...
*/
class MANTIDUI_WIDGETS_CORE_PUBLIC ProjectSavePresenter {
public:
