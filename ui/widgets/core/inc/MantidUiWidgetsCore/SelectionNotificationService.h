...
*/
class MANTIDUI_WIDGETS_CORE_PUBLIC SelectionNotificationServiceImpl
    : public QObject {
  Q_OBJECT
...
namespace Mantid {
namespace Kernel {
MANTIDUI_WIDGETS_CORE_EXTERN template class MANTIDUI_WIDGETS_CORE_PUBLIC Mantid::Kernel::
