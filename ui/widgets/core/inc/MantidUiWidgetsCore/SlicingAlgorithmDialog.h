...
*/
class MANTIDUI_WIDGETS_CORE_PUBLIC SlicingAlgorithmDialog
...
*/
class MANTIDUI_WIDGETS_CORE_PUBLIC SliceMDDialog
...
*/
class MANTIDUI_WIDGETS_CORE_PUBLIC BinMDDialog
    : public SlicingAlgorithmDialog {
  Q_OBJECT
public:
