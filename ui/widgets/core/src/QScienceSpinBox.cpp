#include "MantidUiWidgetsCore/QScienceSpinBox.h"
#include <limits>
...
int QScienceSpinBox::decimals() const { return dispDecimals; }

void QScienceSpinBox::setDecimals(int value) { dispDecimals = value; }
...
void QScienceSpinBox::setLogSteps(bool logSteps) { m_logSteps = logSteps; }
...
// overwritten virtual function of QAbstractSpinBox
void QScienceSpinBox::fixup(QString &input) const { input.remove(thousand); }
